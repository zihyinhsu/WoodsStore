...
- **總覽**：本月出貨收益／進貨成本／出貨成本／毛利（皆未稅、已扣整單折讓），下方以指定期間分兩個分頁：
  「客戶毛利」（左為毛利排行圖、右為逐客戶清單，可搜尋、分頁，點列或點長條開該客戶的商品組成明細）、
  「商品明細」（逐商品進出貨成本分析）。客戶毛利不含未指定客戶的出貨單，故其合計會小於商品明細的期間毛利
- **商品管理**：所有商品／庫存不足分頁檢視、商品 CRUD、即時庫存（流水帳計算）、搜尋、分頁
- **單據管理**：進貨／銷貨／調整單、草稿流程（存草稿 → 確認生效）、作廢回沖、付款狀態、時間區間＋關鍵字搜尋
- **收款管理**：客戶應收餘額、勾選出貨單開立收款（金額為所選單據加總）、時間區間＋關鍵字搜尋
- **對帳單**：依期間產生各客戶應收明細、多選批次列印
- **往來對象**：供應商／客戶管理；點客戶列可直接看該客戶的毛利分析（與總覽同一個 modal）
